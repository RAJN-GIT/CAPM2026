...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PurchaseorderListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onThePurchaseorderListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePurchaseorderListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onThePurchaseorderListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onThePurchaseorderListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onThePurchaseorderListGenerated.onFilterBar().iExecuteSearch();
            Then.onThePurchaseorderListGenerated.onTable(defaultTableId).iCheckRows();
            When.onThePurchaseorderListGenerated.onTable(defaultTableId).iPressRow(0);
